...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('backend/sneat-bootstrap-html-admin-template-free/') }}/assets/css/demo.css" />
    ...
    <!-- Page -->
    <link rel="stylesheet"
        href="{{ asset('backend/sneat-bootstrap-html-admin-template-free/') }}/assets/vendor/css/pages/page-auth.css" />
